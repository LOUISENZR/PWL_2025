            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-sm table-bordered table-striped">
                        ...
                        <tr>
                            <th class="text-right col-3">Dibuat:</th>
                            <td class="col-9">{{ $supplier->created_at }}</td>
                        </tr>
                        <tr>
                            <th class="text-right col-3">Diperbarui:</th>
                            <td class="col-9">{{ $supplier->updated_at }}</td>
                        </tr>
                    </table>
                </div>
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.status) {
                                ...
                                dataSupplier.ajax.reload(); // Pastikan dataSupplier adalah instance DataTables
                            } else {
                                $('.error-text').text('');
